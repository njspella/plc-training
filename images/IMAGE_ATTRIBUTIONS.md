...
| `safety_laser_scanner_3d.jpg` | [CrossingSafety 07g4838.jpg](https://commons.wikimedia.org/wiki/File:CrossingSafety_07g4838.jpg) | ISAKA Yoji (User:Cory) | [CC BY 2.1 JP](https://creativecommons.org/licenses/by/2.1/jp/deed.en) (multi-license file; CC BY 2.1 JP cited on Commons) |
| `safety_light_curtain.png` | Rasterized from [Lightcurtain.svg](https://commons.wikimedia.org/wiki/File:Lightcurtain.svg) (960px PNG) | PetjaTouru (derivative of prior work) | [CC BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0/) |
| `io_contactor_relay.jpg` | [Contactor DIN IEK.jpg](https://commons.wikimedia.org/wiki/File:Contactor_DIN_IEK.jpg) | Kae | [CC BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0/) |
| `io_stack_light.jpg` | [Signalsäule an einer grossen selbstfahrenden Baumaschine (rot gelb grün).jpg](https://commons.wikimedia.org/wiki/File:Signals%C3%A4ule_an_einer_grossen_selbstfahrenden_Baumaschine_(rot_gelb_gr%C3%BCn).jpg) | User:Mattes | Public domain (self-declared on Commons) |
